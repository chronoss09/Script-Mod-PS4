...
--Disable dithering
local no_dith1 = R3K_ReadMem16(0x0697FC)
if no_dith1 == 0x0200 then
R3K_WriteMem16(0x300697FD,0x0000)
end
local no_dith2 = R3K_ReadMem16(0x06A4C8)
if no_dith2 == 0x0200 then
R3K_WriteMem16(0x3006A4C9,0x0000)
end 
